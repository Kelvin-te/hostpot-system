...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('hotspot_authorizations', function (Blueprint $table) {
            ...
            $table->foreignId('payment_transaction_id')->nullable()->index();
            $table->string('client_identifier')->nullable();
            $table->string('hotspot_username')->nullable()->index();
            $table->text('hotspot_password_encrypted')->nullable();
            ...
            $table->unique(['payment_transaction_id', 'package_id']);
        });
    }
